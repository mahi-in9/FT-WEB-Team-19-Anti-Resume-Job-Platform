...
import { ArrowRightIcon, CodeIcon, ShieldCheckIcon, ChartBarIcon, SparklesIcon } from '@heroicons/react/outline';
...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
            {/* Navigation */}
            <nav className={`fixed w-full z-10 transition-all ${scrolled ? 'bg-white shadow-md py-2' : 'bg-transparent py-4'}`}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        <div className="flex items-center">
                            <div className="flex-shrink-0 flex items-center">
                                <SparklesIcon className="h-8 w-8 text-indigo-600" />
                                <span className="ml-2 text-xl font-bold text-indigo-600">SkillProof</span>
                            </div>
                        </div>
                        <div className="hidden md:block">
                            <div className="ml-10 flex items-center space-x-8">
                                ...
                                <a href="#how-it-works" className="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium">How It Works</a>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
                        {['Netflix', 'Google', 'Stripe', 'Airbnb', 'Spotify'].map((company) => (
                            <div key={company} className="col-span-1 flex justify-center items-center opacity-70 hover:opacity-100 transition-opacity">
                                <div className="h-12 text-xl font-bold text-gray-700">{company}</div>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section id="how-it-works" className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">How SkillProof Works</h2>
                    ...
                    <div className="flex justify-center mb-10">
                        <div className="inline-flex rounded-md shadow-sm">
                            <button
                                ...
                                className={`px-6 py-3 text-sm font-medium rounded-l-lg ${activeTab === 'candidates' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                            >
                                For Candidates
                            </button>
                            <button
                                onClick={() => setActiveTab('employers')}
                                className={`px-6 py-3 text-sm font-medium rounded-r-lg ${activeTab === 'employers' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                            >
                                For Employers
                            </button>
                        </div>
                        ...
                        {activeTab === 'candidates' ? (
                            <div className="grid md:grid-cols-3 gap-8">
                                <div className="text-center">
                                    ...
                                    <h3 className="text-lg font-medium text-gray-900 mb-2">Solve Real Challenges</h3>
                                ...
                                <div className="text-center">
                                    ...
                                    <h3 className="text-lg font-medium text-gray-900 mb-2">Blind Evaluation</h3>
                                    <p className="text-gray-600">
                                ...
                                <div className="text-center">
                                    ...
                                    <h3 className="text-lg font-medium text-gray-900 mb-2">Get Matched</h3>
                                    <p className="text-gray-600">
                            ...
                            <div className="grid md:grid-cols-3 gap-8">
                                <div className="text-center">
                                    ...
                                    <h3 className="text-lg font-medium text-gray-900 mb-2">Post Challenges</h3>
                                    <p className="text-gray-600">
                                ...
                                <div className="text-center">
                                    ...
                                    <h3 className="text-lg font-medium text-gray-900 mb-2">Review Anonymously</h3>
                                    <p className="text-gray-600">
                                ...
                                <div className="text-center">
                                    ...
                                    <h3 className="text-lg font-medium text-gray-900 mb-2">Hire the Best</h3>
                                    <p className="text-gray-600">
            ...
            <section id="features" className="py-20 bg-indigo-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">Why SkillProof is Different</h2>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
